...
/*!********************************!*\
  !*** ./src/js/certificates.js ***!
  \********************************/
/*! exports provided: createContent, checkMoreContent, removeContent, wtiteNoResults */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkMoreContent", function() { return checkMoreContent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeContent", function() { return removeContent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wtiteNoResults", function() { return wtiteNoResults; });
...
/***/ "./src/js/html-elements.js":
/*!*********************************!*\
  !*** ./src/js/html-elements.js ***!
  \*********************************/
/*! exports provided: HTMLInclude, addLodingIcon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HTMLInclude", function() { return HTMLInclude; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addLodingIcon", function() { return addLodingIcon; });
...
/*!*************************!*\
  !*** ./src/js/index.js ***!
  \*************************/
/*! exports provided: searchByTag */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "searchByTag", function() { return searchByTag; });
...
/* harmony import */ var _html_elements__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./html-elements */ "./src/js/html-elements.js");
/* harmony import */ var _certificates__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./certificates */ "./src/js/certificates.js");
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tags */ "./src/js/tags.js");
...
const navbarLoadedCallback = function () {
  ...
  searchElement.addEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(searchCertificates, 1000));
}
...
window.customElements.define("html-include", _html_elements__WEBPACK_IMPORTED_MODULE_4__["HTMLInclude"]);

//other basic events
window.toggleModal = _navigation__WEBPACK_IMPORTED_MODULE_3__["toggleModal"];
window.goBack = _navigation__WEBPACK_IMPORTED_MODULE_3__["goBack"];
...
async function searchCertificates(event) {
  ...
  Object(_certificates__WEBPACK_IMPORTED_MODULE_5__["removeContent"])();
  certificates = await getCertificates(1, 100, search);
  if (certificates.length) {
    Object(_certificates__WEBPACK_IMPORTED_MODULE_5__["createContent"])(certificates, currentPage);
  } else {
    Object(_certificates__WEBPACK_IMPORTED_MODULE_5__["wtiteNoResults"])(search);
  }
}
...
async function searchByTag(event) {
  ...
  if (certificates.length !== 0) {
    ...
    Object(_certificates__WEBPACK_IMPORTED_MODULE_5__["wtiteNoResults"])(tagName);
  }
}
